...
// this file is the test to count the number of ms the ip runs.
...
//		int temp=ALT_CI_RECON_TOP_PIPELINE_0(datatest[i]);
...
//		int ref=top(datatest[i],&recon,&ma);
//
//
//		int diff = ref - model;
...
//     printf("MSE after %d samples: %f\n", dataset_size, mse);
	...
	//    	ALT_CI_RECONSTRUCTION_TOP_0(1000);
//			dummy_function();
	//    	printf("\n");
	//
